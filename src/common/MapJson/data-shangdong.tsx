    ...
    "features": [
        ...
        },
        {
            ...
            "geometry": {
                ...
                "coordinates": [
                    [
                        "@@ACMBMECBABBB@FBDJCJBJABC",
                        "@@DABEC@CDBD",
                        "@@D@BGBGCAG@@DAFBHB@",
                        "@@SHKCM@GCOBI@EF@DBDFBDFD@V@BBAJD@D@PEROL@BEAEAA",
                        "@@HC@CAAC@EFEBBDF@",
                        "@@BBD@BEEGA@CDDF",
                        "@@H@BCCAID@@BB",
                        "@@FAFEBCCCC@CBC@CB@FDD",
                        "@@DDD@BABIAEEACB@L",
                        "@@D@BAEEAB@D",
                        "@@BKFK@CACEBEDEDAD@FFNDBDA",
                        "@@BFBBD@BAAGBCEGC@@D@H",
                        "@@LBBAECCBE@ABB@",
                        "@@AB@BBC",
                        "@@DA@AA@AB",
                        ...
                        "@@DA@EC@CBADDB",
                        "@@DDBA@CACA@@BC@@D",
                        "@@NHF@DAACA@C@EEQG@BFH",
                        "@@A@@DDAAA",
                        "@@AB@BBA@A",
                        "@@BBBAACA@@B",
                        "@@TXDFDLJDJBBGAOFSBCJIDE@CAEGGGCUIMAIDEDCHAF@HBLBD",
                        "@@DHHDBFDABEGIEABGCCC@CF@DDB",
                        "@@DABC@EACE@EBBHBD",
                        "@@ALBBDADCHMCAE@CF",
                        "@@BACAADB@",
                        "@@D@@ECD",
        ...
        },
        {
            ...
            "geometry": {
                ...
                "coordinates": [
                    [
                        "@@EBCB@F@FHFLDDBBFHHF@D@HEPOBGBCCESFKEGDC@",
                        "@@E@IDGFQTEF@FBFDDDBTBDDFABECE@ELADA@CAAIAAC@CJIBC@C",
                        "@@AB@DFJ@BED@DFFAHBDHADEDIJCBCIKQE",
                        "@@GDAF@DBDJLJ\\HHJDZDL@NCJEDEBCCGIKOCW@EACCEMIEIA",
                        "@@EHOJCF@ZJrBFBBF@DCHKNeDATALCNMFI@CEAYAWFG@EA@C@ECG",
                        "@@KBADAH@HFJDDH@LKBEAEAEGE",
                        "@@BDBACI@F",
                        "@@E@GFGHCRBDB@JGJ@LCDI@GEE",
                        "@@CFBDBBB@ACFBBA@AE@AE",
                        "@@DABA@CACBCA@A@@DCDBD",
                        "@@C@CFEEA@CB@FBDJF@FAF@DRH@HHBDMAOCIKK",
                        "@@A@AFBDBDB@DC@EAA",
                        "@@aBEDAFJFPHH@LEHK@CGA",
                        "@@B@AC@D",
                        "@@@@",
                        "@@BBBAFBJEAAGBBBA@CAADA@",
                        "@@B@@@A@",
                        "@@@@",
                        "@@@BD@@AA@",
                        "@@B@AA",
            ...
            "geometry": {
                ...
                "coordinates": [
                    [
                        ...
                        "@@B@BACACBBB",
                        "@@A@CD@DFABAAC",
                        "@@FBDCJ@BCCADCB@@ACA@BGBCCEBD@@DDBCBC@ADE@@DCBB@HC",
                        "@@@DD@CC",
                        "@@ADBA@A",
                        "@@ABBA",
                        "@@BA@AA@@BAB",
                        "@@@BB@BD@FADDB@CB@@CDA@ACAAACA",
                        "@@C@BBB@@A",
                        "@@EDDBDC@A",
                        "@@JH@DB@BFBCH@FEAAEBACE@ACAC@EKBCFDB"
                    ]
                ],
                "encodeOffsets": [
                    [
