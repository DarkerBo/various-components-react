            ...
            "geometry": {
                ...
                "coordinates": [
                    [
                        ...
                        "@@ABD@BAB@@AA@CD",
                        "@@B@CA@@@B",
                        "@@CAA@BFCFFBBFD@@CDCAAFAAEG@",
                        "@@ADEB@BCDDFGLFJCFFANBDGAEEAA@AI@ELIAAE@AA",
                        "@@@BB@AA",
                        "@@DABAD@BEGBED@BC@DB",
                        "@@BDD@AEDAAAED",
                        "@@@DBA@A",
                        ...
                        "@@C@EFD@JABAB@@A",
                        "@@IBCDHCDBBC",
                        "@@YFGFAFVHDDD@JAL@HABGK@BGKG",
                        "@@BDLHBBRJFALADAC@@CFEB@DAGEEDEAAAMABCACCB@HCBC@CBCEGB",
                        "@@G@CFEBADJDDAB@BHCFBBF@@HDADGHB@BCB@DFDFCDCACDA@GIGKCI@DEAA",
                        "@@BBBAAAAB",
                        "@@BBD@CEAB",
                        "@@A@BBBAA@",
                        "@@@@B@@AA@",
                        "@@DBACA@",
                        "@@CBF@AA",
                        "@@EDAFEB@FDDN@FFFBDE@EC@ECGM",
                        "@@IBCD@HKFKJMDCCA@GF@@FBJADBF@J@DIFCVGHK@AEA",
                        "@@DEIDC@@CCDA@@DZH@AECCC",
                        "@@AB@DC@AB@BF@FCBCEA",
                        "@@DBACAB",
                        "@@B@@AC@BB",
                        "@@BCC@EBE@ABC@GFAAIBC@ABBDF@B@@BD@FBDEDB@CDABCF@@AF@",
                        "@@F@FCCCEBAB@D",
                        "@@@BD@HAEACB",
                        "@@MBKLGLAL@HJTDN@FCFIFCFAHDPBFF@VA\\GH@DBBFAFIJ@F@DF@TEHE@IEE@EBEVEHELS@KAIGKGG]MYYEC",
                        "@@EBCD@FDFTHJGF@@ICCG@ADA@KG",
                        "@@@ADE@AKIWHKBCBC@ADEEA@ABC@@DCDEA@BDBABIA@DGHGCABCF@BFAHBBAD@BDADE@BDC@ABDBC@CFIB@DED@BFBDABBFA@ADABDCFDBDB@BDB@CD@DBBEACBAB@BAD@@ACCBC@CD@@CHAH@DD@BBDBAHAHC@ADACCBAACHAACAAB@@ABA@BFAF@AFBB@CFG",
                        "@@B@@EFCCCCAAB@DB@CFBD",
                        "@@A@AB@AC@DDDABB@C",
                        "@@DBP@@CCCECCDGB@BABD@",
                        "@@@FAHC@@BHDJ@@BAFKBABJD@DCDDBTABAAC@AGIAC@CDABEHEBCIECE@AIECDBBABIBDBED@BFB",
                        "@@HA@AE@EBBB",
                        "@@DB@AAAC@CDBBBCB@",
                        "@@DAAE@@C@@FBB",
                        "@@@BFDDCAAE@",
